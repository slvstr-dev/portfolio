  ...
  return (
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content
        className={cn(
          'text-gray-900 fixed left-1/2 top-1/2 w-full max-w-md -translate-x-1/2 -translate-y-1/2 bg-theme-brand-100 p-8 data-[state=closed]:animate-[dialog-content-hide_200ms] data-[state=open]:animate-[dialog-content-show_200ms]',
          className,
        )}>
        <div className="flex items-center justify-between">
          ...
          <DialogPrimitive.Close asChild>
            <Icon icon="X" className="h-8 w-8 cursor-pointer transition-opacity hover:opacity-50" />
